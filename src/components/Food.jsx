...
const filterPrice = (price) => {
  ...
  return (
    <div className='max-w-[1160px] m-auto px-4 py-12'>
        ...
        <div className='flex flex-col lg:flex-row justify-between'>
            ...
            <div>
                ...
                {/* justify-between k sath error miss  pr sahi, neeche div me */}
            ...
            {/* Filter Price */}
            <div>
                <p className='font-bold text-gray-700'>FilterPrice</p>
        ...
        {/* Display foods */}
        <div className='grid grid-cols-2 lg:cols-4 gap-6 pt-4'>
